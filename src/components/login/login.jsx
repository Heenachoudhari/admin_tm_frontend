  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white">
      ...
      <div className="flex w-full h-screen shadow-lg rounded-none overflow-hidden">
        {/* Left Panel */}
        <div className="w-1/2 h-full bg-[url('/login/userlogin.png')] bg-cover bg-center p-8 flex flex-col justify-center items-center relative">
        ...
        >
          ...
          <Image src="/login/vector2.png" alt="vector" height={45} width={45} className="absolute z-0" style={{ bottom: '45px', right: '128px' }} />
          <Image src="/login/vector.png" alt="vector" height={85} width={85} className="absolute z-[-1]" style={{ bottom: '50px', left: '73px' }} />
          <Image src="/login/vector_pencile.png" alt="vector" height={400} width={96} className="absolute z-0 bottom-[60px] left-[300px] rotate-[-10deg]" />
