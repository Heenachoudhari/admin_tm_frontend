        ...
        <div className="min-h-screen w-full flex items-center justify-center bg-white">
            ...
            <div className="flex w-full h-screen shadow-lg rounded-none overflow-hidden">
                ...
                <div
                    ...
                    style={{
                        backgroundImage: 'url("/bg.jpg"), url("/bg2.png")',
                ...
                >
                    ...
                    <Image src="/login/vector.png" alt="vector" height={85} width={85} className="absolute z-[-1]" style={{ bottom: '64px', left: '51px' }} />
                    <Image src="/login/vector_pencile.png" alt="vector" height={400} width={96} className="absolute z-0 bottom-[60px] left-[200px] rotate-[-10deg]" />
