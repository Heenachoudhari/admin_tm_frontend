    ...
    return (
        <div className="min-h-screen flex items-center justify-center bg-[url('/loginbg.png')] bg-cover bg-center relative">
            <div className="relative bg-white rounded-lg shadow-lg p-12 w-full max-w-3xl z-10 h-120 text-center">
                <Image src="/forgetpassword/image2.png" alt="vector" height={100} width={100} className="absolute top-204.71px left-432.82px rotation-160.01 deg z-0 " />
                <Image src="/forgetpassword/image1.png" alt="vector" height={70} width={60} className="absolute top-15 right-10 z-0" />
                <Image src="/forgetpassword/image8.png" alt="vector" height={80} width={80} className="absolute top-50 left-5 rotate-[350deg] z-[-1]" />
                <Image src="/forgetpassword/image3.png" alt="vector" height={80} width={80} className="absolute bottom-14 left-25 right-30 rotate-[350deg] z-0" />
                <Image src="/forgetpassword/image4.png" alt="vector" height={80} width={80} className="absolute top-40 right-40 rotate-[15deg] z-0" />
                <Image src="/forgetpassword/image7.png" alt="vector" height={80} width={80} className="absolute top-77 right-10 left-128 z-0" />
                <Image src="/forgetpassword/image5.png" alt="vector" height={85} width={85} className="absolute top-64 left-51 z-[-1]" />
                <Image src="/forgetpassword/image6.png" alt="vector" height={80} width={80} className="absolute top-7 right-50 z-0" />
