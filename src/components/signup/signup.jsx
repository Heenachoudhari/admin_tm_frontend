...
export default function Signup() {
  ...
  return (
    ...
    >
      ...
      >
          <Image src="/login/vector.png" alt="vector" width={60} height={60} className="absolute top-10 right-45 z-0" />
  <Image src="/login/vector.png" alt="vector" width={60} height={60} className="absolute bottom-10 left-100 rotate-300 " />
  <Image src="/login/vector3.png" alt="vector" width={40} height={40} className="absolute top-1/2 left-22 " />
  <Image src="/login/vector1.png" alt="vector" width={40} height={40} className="absolute top-17 left-20 " />
  
  <Image src="/login/vector3.png" alt="vector" width={40} height={40} className="absolute bottom-8 left-40" />
  <Image src="/login/vector3.png" alt="vector" width={40} height={40} className="absolute bottom-8 right-40 scale-x-[-1]" />
  <Image src="/login/vector3.png" alt="vector" width={40} height={40} className="absolute bottom-50 right-20 scale-x-[-1] 
 " />
  <Image src="/login/vector1.png" alt="vector" width={45} height={45} className="absolute top-70 right-23 scale-x-[-1] "  />
